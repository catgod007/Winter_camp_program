...
CREATE TABLE `student_info`  (
  `username` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学生的唯一标识符',
  ...
  `birthday` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '学生的出生日期',
  ...
  `note` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学生的备注信息',
  `status` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学生的状态',
  `level_id` int(11) NULL DEFAULT NULL COMMENT '学生的所在年级',
...
-- ----------------------------
INSERT INTO `student_info` VALUES ('111', 2023003, '女', '2024-01-20 16:57:54', '13673278324234', 'example3@email.com', '广州市天河区', '优秀学生干部', '在读', 2021, '2021-11-07 00:00:00', 2, 2);
INSERT INTO `student_info` VALUES ('王琦', 2023004, '男', '2002-01-01 13:30:07', '13673224323', 'example4@email.com', '重庆市合川区', '优秀团支书', '在读', 2022, '2022-11-05 00:00:00', 2, 3);
INSERT INTO `student_info` VALUES ('李莉莉', 2023005, '女', '2002-01-06 13:30:33', '19337842983', 'example5@email.com', '重庆市北碚区', '三好学生', '在读', 2022, '2022-11-09 00:00:00', 2, 4);
INSERT INTO `student_info` VALUES ('白艳丽', 2023006, '女', '2002-07-20 13:31:02', '18234567823', 'example6@email.com', '重庆市渝北区', '优秀班干部', '在读', 2022, '2022-12-07 00:00:00', 2, 5);
INSERT INTO `student_info` VALUES ('包春华22', 2023007, '男', '2024-01-20 12:08:26', '18247525788', 'example7@email.com', '重庆市江北区', '优秀学生', '在读', 2022, '2022-08-07 00:00:00', 2, 6);
INSERT INTO `student_info` VALUES ('李阳', 2023008, '男', '2002-01-20 13:32:12', '19037845729', 'example8@email.com', '贵州贵阳', '学生', '在读', 2022, '2022-09-07 00:00:00', 2, 7);
INSERT INTO `student_info` VALUES ('杨雯', 2023009, '女', '2002-01-14 13:33:07', '13673325435', 'example9@email.com', '江西南昌', '三好学生', '在读', 2022, '2022-10-07 00:00:00', 2, 8);
INSERT INTO `student_info` VALUES ('王亮', 20230010, '男', '2002-03-18 13:27:50', '18364728483', 'example10@email.com', '河北石家庄', '特长生', '在读', 2022, '2022-11-13 00:00:00', 2, 9);
INSERT INTO `student_info` VALUES ('wqe1', NULL, '男', '2024-01-20 14:48:42', 'wqeq', 'qweqr', 'ewrwr', NULL, NULL, NULL, '0000-00-00 00:00:00', NULL, 24);
INSERT INTO `student_info` VALUES ('234', NULL, '男', '2024-01-20 16:58:12', '24', '32545', '325235', NULL, NULL, NULL, '0000-00-00 00:00:00', NULL, 25);
...
CREATE TABLE `teacher_info`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教师' ROW_FORMAT = Dynamic;
